...
const RecipeDetails = () => {
  ...
  const handleAddToFavorites = async () => {
    ...
    try {
      await axios.post(`${import.meta.env.VITE_API_URL}/api/users/${username}/favorites`, {
        recipeId: recipe._id,
      }, {
        headers: {
  ...
  const handleCommentSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`${import.meta.env.VITE_API_URL}/api/comments/${id}`, {
  ...
  return (
    ...
    <div className="container recipe-details">
      ...
      <img src={`${import.meta.env.VITE_API_URL}${recipe.image}`} alt={recipe.name} className="recipe-image" />
      <section>
      <h3>Ingredients:</h3>
